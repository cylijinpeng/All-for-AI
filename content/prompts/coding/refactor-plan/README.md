...
Prompt for converting messy code or a broad cleanup request into a staged refactor plan.
...
- Constraints
- Step-by-step plan
- Risk controls and test plan

## Files in this entry

- [`refactor-plan.prompt.yml`](refactor-plan.prompt.yml)
